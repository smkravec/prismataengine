...
public:
    ...
    Player_Python (PyObject* self_, const Prismata::PlayerID playerID): self(self_), m_playerID(playerID) {}
    ...
    Prismata::PlayerPtr clone() { return Prismata::PlayerPtr(new Player_Python(*this)); }
};
...
int ohTable4 [30] = {1,5,100,22,10,10,27,27,27,22,22,10,10,10,10,10,100,22,10,10,27,27,27,22,22,10,10,10,10,10};

int ohTable11 [82] = {1,5,100,22,10,10,10,10,27,27,27,22,22,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,100,22,10,10,10,10,27,27,27,22,22,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10};
}; // namespace GameState
namespace Card {
